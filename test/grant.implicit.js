...
describe('Granting with implicit grant type', function () {
  ...
  it('should detect invalid user', function (done) {
    var app = bootstrap({
      model: {
        ...
        getUserFromClient: function (clientId, callback) {
    ...
    request(app)
      ...
      .set('Authorization', 'Basic dGhvbTphbnlzdHJpbmc=')   // Set random string in client secret
