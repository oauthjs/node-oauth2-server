...
- *function* **customError (error, description, err)**
 - If set, errors will trigger this function instead of the internal error handler.
  - Default: `undefined`
  - **error**: the internal error code
  - **description**: a human-friendly error description
  - **err**: the exception object which triggered the error in the first place
