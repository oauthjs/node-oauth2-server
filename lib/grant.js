...
function useClientCredentialsGrant (done) {
  ...
  // Get parameters and pass along to this.model.getUserFromClient
  // so the model can handle how to look up the user.
  ...
  if (Object.keys(params).length > 0) {
    return this.model.getUserFromClient(clientId, clientSecret, params, modelCB);
  }else{
    return this.model.getUserFromClient(clientId, clientSecret, modelCB);
  }
}
