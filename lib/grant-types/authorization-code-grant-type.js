...
AuthorizationCodeGrantType.prototype.getAuthorizationCode = function(request, client) {
  ...
  return promisify(this.model.getAuthorizationCode, 1)(request.body.code)
    .then(function(code) {
      ...
      if (typeof code.client.id !== "object" && typeof client.id !== "object" && code.client.id !== client.id) {
        throw new InvalidGrantError('Invalid grant: authorization code is invalid');
      }
      else if (typeof code.client.id === "object" && typeof client.id === "object" && code.client.id.toString() !== client.id.toString()) {
