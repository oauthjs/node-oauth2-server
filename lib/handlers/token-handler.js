...
TokenHandler.prototype.handle = function(request, response) {
  ...
  return Promise.all(fns)
    .bind(this)
    .spread(function(accessToken, refreshToken, accessTokenExpiresOn, refreshTokenExpiresOn, client) {
      return this.handleGrantType(request, client)
        ...
        .then(function(user) {
          return this.saveToken(accessToken, refreshToken, accessTokenExpiresOn, refreshTokenExpiresOn, client, user);
        })
        .then(function(token) {
...
TokenHandler.prototype.saveToken = Promise.method(function(accessToken, refreshToken, accessTokenExpiresOn, refreshTokenExpiresOn, client, user) {
  var token = {
...
TokenHandler.prototype.getTokenType = function(token) {
  return new BearerTokenType(token.accessToken, this.accessTokenLifetime, token.refreshToken);
};
